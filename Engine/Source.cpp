...
int main(int argc, char** argv) {
	...
	// Generate random numbers for use in fireball placement.
	srand((unsigned)time(0));

	// Create SDL_Rect for all game objects.
	...
	// Only one of these enemies is created because without vertical movement it cannot be dodged, so it's a game ender.
	SDL_Rect rjerk1 = { -500,150,131,131 };
